  ...
  return (
    <div className="footer-bg">
        ...
        <Row className="text-white">
          ...
          <Col xs={6} md={3}>
            <div className="single-footer-widget">
              ...
              <div className="widget-content">
                <NavLink className="footer-link">telangana hyderabad</NavLink>
                <NavLink className="footer-link">Village Dr Mason, NY.</NavLink>
                <NavLink className="footer-link">Phone: 9705627977</NavLink>
                <NavLink className="footer-link">
                  Email:Kandulanaveennaidu017@gmail.com
                </NavLink>
                <NavLink className="footer-link">Fax:+919705627977</NavLink>
              </div>
            </div>
          </Col>
        </Row>
      ...
      <div className="footer-copy-right text-center text-white">
        <p className="mb-0">
          &copy; 2022 - <span className="developer">Kandula Naveen</span> | All
          Rights Reserved
        </p>
      </div>
    </div>
